...
def warn_external_tools() -> None:
    ...
    if missing:
        ...
        print("Установите Android Platform Tools или укажите пути в ~/.xhelper_config.json.")
    if shutil.which("scrcpy") is None:
        print("Подсказка: scrcpy не найден. Зеркалирование экрана будет недоступно до его установки.")
...
def main() -> int:
    ...
    print("Запуск: используйте созданный run_xhelper_2_0_release.* файл или ярлык на рабочем столе.")
    return 0
